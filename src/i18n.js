...
const resources = {
  en: {
    translation: {
      ...
      luckyNew: {
        tag: "Divine Draw",
        title: "Win Spectacular Prizes Every Month",
        subtitle: "Support the temple's development and get a chance to win amazing gifts including vehicles, appliances, and more.",
        learnMore: "How it works",
        cardTitle: "Mega Lucky Draw",
        cardPrice: "₹500 / Ticket",
        cardIncludes: "Included with every ticket:",
        tag1: "Live Draw Access",
        tag2: "Digital Receipt",
        tag3: "Instant Confirmation",
        tag4: "SMS Alerts",
        buyBtn: "Purchase Ticket Now"
      },
      donate: {
        pageTitle: "Daily & Special Sevas",
        subtitle: "Participate in the sevas of Maa Badi Mata",
        tabDaily: "Daily Seva",
        tabTuesday: "Tuesday Special",
        tabNavratri: "Navratri",
        tabOnline: "Online Sevas",
        tabBhandara: "Bhandara Seva",
        tabGau: "Gau-Seva",
        bookBtn: "Book Now",
        seva1Title: "Akhand Deep Seva",
        seva1Desc: "Participate in the continuously lit lamp seva",
        seva2Title: "Pushpa Seva",
        seva2Desc: "Auspicious resolve to offer flowers to Maa",
        seva3Title: "Bhog Seva",
        seva3Desc: "Special food offering seva for Maa",
        seva4Title: "Aarti Seva",
        seva4Desc: "Name resolve seva in daily Aarti",
        seva5Title: "Vastra Seva",
        seva5Desc: "Special clothing offering for Maa",
        seva6Title: "Shringar Seva",
        seva6Desc: "Contribution to daily Shringar seva",
        seva7Title: "Annadaan Seva",
        seva7Desc: "Feeding the hungry — The greatest donation",
        seva8Title: "Vishesh Sankalp Seva",
        seva8Desc: "Wish fulfillment resolve pooja seva"
      },
      founders: {
  ...
  hi: {
    translation: {
      ...
      luckyNew: {
        tag: "दिव्य ड्रा",
        title: "हर महीने शानदार पुरस्कार जीतें",
        subtitle: "मंदिर के विकास में सहयोग करें और वाहन, उपकरण और अन्य अद्भुत उपहार जीतने का अवसर पाएं।",
        learnMore: "यह कैसे काम करता है",
        cardTitle: "मेगा लकी ड्रॉ",
        cardPrice: "₹500 / टिकट",
        cardIncludes: "प्रत्येक टिकट के साथ शामिल:",
        tag1: "लाइव ड्रॉ एक्सेस",
        tag2: "डिजिटल रसीद",
        tag3: "तत्काल पुष्टि",
        tag4: "एसएमएस अलर्ट",
        buyBtn: "अभी टिकट खरीदें"
      },
      donate: {
        pageTitle: "दैनिक एवं विशेष सेवाएँ",
        subtitle: "माँ बड़ी माता की सेवाओं में सहभागी बनें",
        tabDaily: "दैनिक सेवा",
        tabTuesday: "मंगलवार विशेष",
        tabNavratri: "नवरात्रि",
        tabOnline: "ऑनलाइन सेवाएँ",
        tabBhandara: "भंडारा सेवा",
        tabGau: "गौ-सेवा",
        bookBtn: "बुक करें",
        seva1Title: "अखंड दीप सेवा",
        seva1Desc: "निरंतर प्रज्वलित दीप सेवा में सहभागी बनें",
        seva2Title: "पुष्प सेवा",
        seva2Desc: "माँ को पुष्प अर्पण का शुभ संकल्प",
        seva3Title: "भोग सेवा",
        seva3Desc: "माँ को विशेष भोग अर्पण सेवा",
        seva4Title: "आरती सेवा",
        seva4Desc: "दैनिक आरती में नाम संकल्प सेवा",
        seva5Title: "वस्त्र सेवा",
        seva5Desc: "माँ को विशेष वस्त्र अर्पण",
        seva6Title: "श्रृंगार सेवा",
        seva6Desc: "दैनिक श्रृंगार सेवा में सहयोग",
        seva7Title: "अन्नदान सेवा",
        seva7Desc: "भूखों को भोजन — महादान",
        seva8Title: "विशेष संकल्प सेवा",
        seva8Desc: "मनोकामना संकल्प पूजा सेवा"
      },
      founders: {
